...
import { initialTaskLayerValues, TaskLayerConfig, TaskLayerOption } from '../layer/task-layer.interface';
...
export const TaskBudgetSection = ({ costLayer }: TaskBudgetSectionProps) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (targetLayer) {
      ...
      const updatedLayer: TaskLayerConfig = {
        ...targetLayer,
      ...
      const newLayer: TaskLayerConfig = {
